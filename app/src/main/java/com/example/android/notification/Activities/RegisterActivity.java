...
import com.example.android.notification.NotifyMain;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mImageBtn = (ImageView) findViewById(R.id.register_image_btn);
    ...
    private void sendToMain() {
        Intent mainIntent=new Intent(RegisterActivity.this,NotifyMain.class);
